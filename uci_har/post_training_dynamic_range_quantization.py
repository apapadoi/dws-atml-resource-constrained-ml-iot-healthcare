...
NUM_EPOCHS = 1000
BATCH_SIZE = 64
MODEL_OUTPUT_FOLDER = "../models/uci_har/post_training_dynamic_range_quantization"
DEVICE = "/device:GPU:1"
...
with tf.device(DEVICE):
    ...
    y_pred_model_quant = evaluate_model(tflite_model_quant_file, X_test)

print("Initial model accuracy: ", accuracy_score(y_test, y_pred_initial_model))
print("Dynamic-range quantized model accuracy: ", accuracy_score(y_test, y_pred_model_quant))

print("Initial model macro F1-score: ", f1_score(y_test, y_pred_initial_model, average='macro'))
print("Dynamic-range quantized model macro F1-score: ", f1_score(y_test, y_pred_model_quant, average='macro'))
